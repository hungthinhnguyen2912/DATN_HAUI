            ...
            Expanded(
              ...
              child:
                  P.image.image.value != null
                      ? Obx(() {
                        return Image.file(P.image.image.value!,width: 300,height: 300,);
                      })
                      : Column(
              ...
              child: Column(
                ...
                children: [
                  ButtonClassification(
                    ...
                    content: "Classify", onTap: () {
                      P.image.uploadToCloudinary();
                  },
                  ),
                  ButtonClassification(
                    icon: Icon(Icons.upload_file,color: AppColors.white),
                    content: "Upload picture from gallery", onTap: () {
